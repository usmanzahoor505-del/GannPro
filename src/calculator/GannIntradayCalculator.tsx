...
import type { GannInput, GannResult } from '@/utils/gannIntradayCalculator';
import { calculateGannLevels } from '@/utils/gannIntradayCalculator';
import GannInputForm from '@/components/intraday/GannInputForm';
import GannResults from '@/components/intraday/GannResults';
import GannWheel from '@/components/intraday/GannWheel';

export default function GannIntradayCalculator() {
  ...
  return (
    <div className="min-h-screen bg-[#05070f] text-white py-12">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:py-6 z-10">
        {/* Header */}
